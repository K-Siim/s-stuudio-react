...
const Information = () => {
  return (
    <div className="relative bg-[#000300] px-6 pb-24 -mt-32 md:-mt-20 lg:mt-0 xl:mt-[20rem]">
      <div className="mt-[-15rem] md:mt-[-25rem] lg:mt-[-35rem] transform-gpu overflow-hidden blur-3xl xl:mt-[-45rem] z-0">
        <div className="relative left-1/2 -z-10 aspect-1155/678 w-[36.125rem] max-w-none -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#00df9a] to-[#00df9a] opacity-30 sm:left-[calc(50%-40rem)] sm:w-[72.1875rem]" style={{clipPath: "polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)"}}></div>
      </div>
      ...
      <form action="#" method="POST" className="mx-auto mt-16 max-w-xl sm:mt-20">
        ...
        <div className="mt-10">
          <button type="submit" className="block w-full rounded-md bg-[#00df9a] px-3.5 py-2.5 text-center text-sm font-semibold text-black shadow-xs hover:bg-[#00bf82] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#00df9a]">Let's talk</button>
        </div>
      </form>
    </div>
  )
